...
public class AllProductAdapter2 extends RecyclerView.Adapter<AllProductAdapter2.ViewHolder>{
    ArrayList<SanPham> list;
    Context context;

    public AllProductAdapter2(ArrayList<SanPham> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_row_all2, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String gb = list.get(position).getGiaban();
